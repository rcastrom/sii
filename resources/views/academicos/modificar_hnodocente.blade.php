    ...
    <x-information :encabezado="$encabezado">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Horario No Docente</h4>
                        <table class="table table-responsive">
                            ...
                            @foreach($apoyos as $apoyo)
                                    <?php $suma_semana2=0;?>
                                <tr>
                                    <td>{{$apoyo->descripcion_puesto}}</td>
                                        <?php
                                        for($i=2;$i<=7;$i++){
                                    ...
                                    <td><i class="fas fa-wrench"></i>
                                        <a href="{{route('nodocente.edit',['nodocente'=>$apoyo->id])}}">
                                            Modificar</a></td>
                                    <td><i class="fas fa-trash-alt"></i>
                                        <a href="{{route('nodocente.show',['nodocente'=>$apoyo->id])}}">
                                            Eliminar</a></td>
                                </tr>
                            @endforeach
                            </tbody>
