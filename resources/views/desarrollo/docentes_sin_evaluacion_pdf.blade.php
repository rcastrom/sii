    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-text">Personal docente que no cuenta con información de haber sido
                    evaluado en el período</p>
                <table class="table table-striped">
                    ...
                    @foreach($datos as $dato)
                        <tr>
                            <td>{{$i}}</td>
                            <td>{{trim($dato->apellidos_empleado.' '.$dato->nombre_empleado)}}</td>
                            @php
                                $i++;
                            @endphp
                        </tr>
