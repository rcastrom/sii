...
<table class="tabla">
    ...
    @foreach($alumnos as $alumno)
        <tr>
            <td width="5%">{{$j}}</td>
            <td width="10%">{{$alumno->no_de_control}}</td>
            <td width="15%">{{$alumno->apellido_paterno}} {{$alumno->apellido_materno}} {{$alumno->nombre_alumno}}</td>
            <td width="60%">&nbsp;</td>
            <td width="15%" align="center">{{$alumno->calificacion==0?"NA":$alumno->calificacion}}</td>
        </tr>
        <?php $j++; ?>
    @endforeach
    </tbody>
